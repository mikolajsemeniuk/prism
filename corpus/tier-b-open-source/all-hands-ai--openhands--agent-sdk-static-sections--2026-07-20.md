---
product: "OpenHands (autonomous software agent)"
vendor: "All Hands AI"
model: "model-agnostic (contains a ModelSpecificSection that varies per model family)"
prompt_date: 2026-07-09  # date of last commit touching the file
provenance_tier: B
source_name: "github.com/OpenHands/software-agent-sdk - openhands-sdk/openhands/sdk/context/prompts/sections/static.py"
source_url: https://raw.githubusercontent.com/OpenHands/software-agent-sdk/f835c38162a629f008ba204acb4a5eeb0f9edfdd/openhands-sdk/openhands/sdk/context/prompts/sections/static.py
source_commit: f835c38162a629f008ba204acb4a5eeb0f9edfdd
accessed: 2026-07-20
archive_url: null
license: MIT
notes: "SOURCE CODE, not raw prompt text: Python module containing the static-tier system prompt sections, ported verbatim (per the module docstring) from the former agent/prompts/system_prompt.j2 Jinja template, which no longer exists in the repo. Note the repo move: the task-specified All-Hands-AI/OpenHands repo was renamed to OpenHands/OpenHands and no longer contains the agent system prompt (only integration templates); the agent and its prompt live in OpenHands/software-agent-sdk. Saved verbatim."
---
