---
product: "Claude (claude.ai)"
vendor: Anthropic
model: "Claude Opus 4.8 (claude-opus-4-8)"
prompt_date: 2026-05-28
provenance_tier: A
source_name: "Anthropic docs - Release notes: System Prompts"
source_url: https://platform.claude.com/docs/en/release-notes/system-prompts.md
source_commit: null  # not applicable (vendor docs page)
accessed: 2026-07-20
archive_url: https://web.archive.org/web/20260720215225/https://platform.claude.com/docs/en/release-notes/system-prompts
license: "not stated (Anthropic documentation, proprietary)"
notes: "Vendor-published prompt. Retrieved from the vendor docs markdown endpoint (https://platform.claude.com/docs/en/release-notes/system-prompts.md); the original URL https://docs.anthropic.com/en/release-notes/system-prompts redirects to https://platform.claude.com/docs/en/release-notes/system-prompts. Cleanup applied: removed the 4-space accordion indentation, unescaped Mintlify markdown-export escapes (backslash before <, _, {), and reduced auto-linkified [URL](URL) self-links to plain URLs. No other changes; ** emphasis markers are part of the published text (identical across models, not version-diff bolding). Line breaks are as rendered by the vendor page; the raw production prompt's internal line breaks may differ. Accordion entry dated \"May 28, 2026\". Single dated entry for this model per the fixed-snapshot policy starting with the Claude 4.6 generation."
---
