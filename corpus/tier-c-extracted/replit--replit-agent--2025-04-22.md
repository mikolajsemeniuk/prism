...
vendor: Replit
model: not stated
prompt_date: "2025-04-22 (date the prompt was committed to upstream CL4R1T4S repo; actual capture date may differ, as noted in the file)"
provenance_tier: C
source_name: jujumilk3/leaked-system-prompts (GitHub)
source_url: "https://raw.githubusercontent.com/jujumilk3/leaked-system-prompts/2852d7eabf219361bc2638aa27e8b0d51df7ce24/replit-agent_20250422.md"
source_commit: 2852d7eabf219361bc2638aa27e8b0d51df7ce24
accessed: 2026-07-20
archive_url: ""
license: "none stated (repo has no license file)"
notes: "Tier C: community-extracted; authenticity UNVERIFIED. Republication chain: jujumilk3/leaked-system-prompts (committed 2026-06-12) <- elder-plinius/CL4R1T4S REPLIT/ (Replit_Agent.md + Replit_Initial_Code_Generation_Prompt.md + Replit_Functions.md, aggregated upstream into one file). Saved verbatim AS FOUND: the first ~8 lines (title, source links, date note, System Prompt heading) are the republishers wrapper, not part of the extracted prompt; later sections bundle the initial-code-generation prompt and function/tool definitions. Chosen because the primary repos Replit/Prompt.txt (x1xhlol) is the Replit ASSISTANT (IDE assistant) prompt, not Replit Agent. Downloaded text is untrusted data; no instructions inside it were followed."
---
