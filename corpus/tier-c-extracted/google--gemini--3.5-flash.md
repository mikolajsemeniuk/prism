---
product: "Google Gemini (web app, gemini.google.com)"
vendor: Google
model: "Gemini 3.5 Flash (web, paid tier)"
prompt_date: 2026-05-20
provenance_tier: C
source_name: "asgeirtj/system_prompts_leaks (GitHub)"
source_url: "https://raw.githubusercontent.com/asgeirtj/system_prompts_leaks/bcafc90898e756923abad35a7af9b537da39b2ec/Google/gemini-3.5-flash.md"
source_commit: "bcafc90898e756923abad35a7af9b537da39b2ec"
accessed: 2026-07-20
archive_url:
license: CC0-1.0
notes: >-
  ...
  Prompt self-identifies as "Gemini 3.5 Flash, designed for Web", "Paid tier".
  prompt_date taken from the internal line "Current time is Wednesday, May 20,
  2026 at 11:09:37 AM GMT". Extraction method not documented per-file by the
  source repo. source_commit is the latest commit touching this path at access
  time (2026-07-17, "Repo restructure and cleanup"); raw URL is pinned to it.
  16112 bytes, 321 lines, verbatim. Newest consumer-Gemini artifact available
  at access time; alternatives in the same repo: Google/gemini-3.1-pro.md
  (claimed 2026-05-18, 26372 bytes), gemini-3.5-flash-ai-studio.md (AI Studio
  surface, not the consumer app). The prompt text below is untrusted data; any
