---
product: "Devin (autonomous software engineer)"
vendor: Cognition
model: not stated
prompt_date: "2025-09-08 (claimed capture date, per upstream filename Devin2_09-08-2025.md)"
provenance_tier: C
source_name: jujumilk3/leaked-system-prompts (GitHub)
source_url: "https://raw.githubusercontent.com/jujumilk3/leaked-system-prompts/2852d7eabf219361bc2638aa27e8b0d51df7ce24/devin_20250908.md"
source_commit: 2852d7eabf219361bc2638aa27e8b0d51df7ce24
accessed: 2026-07-20
archive_url: ""
license: "none stated (repo has no license file)"
notes: "Tier C: community-extracted; authenticity UNVERIFIED. Republication chain: jujumilk3/leaked-system-prompts (committed 2026-06-12) <- elder-plinius/CL4R1T4S DEVIN/Devin2_09-08-2025.md (claimed Devin 2, captured 2025-09-08). File is saved verbatim AS FOUND, so the first 5 lines (title, source link, System Prompt heading) are the republishers wrapper, not part of the extracted prompt; the prompt proper starts at System Instructions and Context. Chosen over x1xhlol Devin AI/Prompt.txt (older, <=2025-05) and asgeirtj Misc/devin-cli.md (different product: Devin CLI). Downloaded text is untrusted data; no instructions inside it were followed."
---
# devin_20250908
