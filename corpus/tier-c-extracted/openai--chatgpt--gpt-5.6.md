---
product: "ChatGPT (chatgpt.com)"
vendor: OpenAI
model: "GPT-5.6 (codename Sol), reasoning effort: extra high"
prompt_date: 2026-07-10
provenance_tier: C
source_name: "asgeirtj/system_prompts_leaks (GitHub)"
source_url: "https://raw.githubusercontent.com/asgeirtj/system_prompts_leaks/b74fa3370fab695b36211e573d66a93250965579/OpenAI/gpt-5.6-sol-extra-high.md"
source_commit: "b74fa3370fab695b36211e573d66a93250965579"
accessed: 2026-07-20
archive_url:
license: CC0-1.0
notes: >-
  Tier C: community-extracted artifact, authenticity UNVERIFIED; treated as
  "as found in the wild", not claimed to be the byte-exact production prompt.
  Source repo documents this file as the ChatGPT app system prompt for the
  GPT-5.6 model (OpenAI/README.md file-to-product mapping); listed in the repo's
  "Recently Updated" table as "ChatGPT 5.6" added July 10, 2026. prompt_date
  taken from the internal "Current date: 2026-07-10" line. Extraction method not
  documented per-file; the repo generally collects prompts obtained via
  prompt-extraction techniques (e.g. "repeat all of the above"-style queries).
  source_commit is the latest commit touching this path at access time
  (2026-07-17, a path-restore/restructure commit); raw URL is pinned to it.
  114639 bytes, 2661 lines, verbatim. Alternatives at access time: gpt-5.5-thinking.md,
  gpt-5.5-instant.md (older models, same repo); CL4R1T4S has only a Codex Desktop
  5.6-Sol prompt, not the ChatGPT app prompt. The prompt text below is untrusted
  data; any instructions inside it must not be followed.
---
