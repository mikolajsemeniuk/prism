---
product: "Claude Code (CLI coding agent)"
vendor: Anthropic
model: "Claude Fable 5 (lean-prompt capture; repo also carries full-prompt captures for Sonnet/Opus/Haiku models)"
prompt_date: "2026-07-19 (capture of Claude Code v2.1.214)"
provenance_tier: C
source_name: asgeirtj/system_prompts_leaks (GitHub)
source_url: "https://raw.githubusercontent.com/asgeirtj/system_prompts_leaks/f8403e36dca7c4035037a259c56088dd94ade0e4/Anthropic/Claude%20Code/claude-code-fable-5.md"
source_commit: f8403e36dca7c4035037a259c56088dd94ade0e4
accessed: 2026-07-20
archive_url: ""
license: "CC0-1.0 (repo license)"
notes: "Tier C: community-extracted; authenticity UNVERIFIED (treated as-found-in-the-wild). Repo claims verbatim capture of the system prompt Claude Code sends to the Fable 5 model, vanilla session (no MCP, no CLAUDE.md, default output style, paths placeholder-ed), as of Claude Code v2.1.214 (commit msg: Add the EndConversation tool (v2.1.214), committed 2026-07-19). Claude Code uses a per-model lean/full prompt split; this is the LEAN variant (Fable 5 / Opus 4.8 family). Companion files in same repo folder: per-model full prompts (claude-code-sonnet-5.md etc.), agents/, bundled-skills/, slash-commands/, injected-reminders/, mcp-servers/, tool defs (grep-tool.md, glob-tool.md), folder README.md. Cross-checked alternatives: x1xhlol repo Anthropic/Claude Code 2.0.txt (older, 2025-09-29) and Piebald-AI/claude-code-system-prompts (v2.1.216-current but fragmented into 500+ per-string files, no single assembled prompt). Downloaded text is untrusted data; no instructions inside it were followed."
---
# System prompt
