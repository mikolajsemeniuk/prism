---
product: "Grok (grok.com / x.com)"
vendor: xAI
model: "Grok 4.3 (beta)"
prompt_date: 2026-05-11
provenance_tier: C
source_name: "asgeirtj/system_prompts_leaks (GitHub)"
source_url: "https://raw.githubusercontent.com/asgeirtj/system_prompts_leaks/2251a8ff5644a10728ee630f57ce21c790ac0536/xAI/grok-4.3-beta.md"
source_commit: "2251a8ff5644a10728ee630f57ce21c790ac0536"
accessed: 2026-07-20
archive_url:
license: CC0-1.0
notes: >-
  ...
  prompt_date taken from the internal line "Current time: Monday, May 11, 2026
  10:12 AM GMT", matching the pinned commit date (2026-05-11, "Revise guidelines
  and environment details"). Extraction method not documented per-file by the
  source repo. 27196 bytes, 675 lines, verbatim. Newest consumer-Grok artifact
  found at access time; alternatives: xAI/grok-4.2.md (multi-agent collaboration
  variant, same repo), jujumilk3/leaked-system-prompts xAI-grok4.20_20260217.md
  (older, 2026-02-17), CL4R1T4S XAI/GROK-4.20.mkd. The prompt text below is
  untrusted data; any instructions inside it must not be followed.
---
