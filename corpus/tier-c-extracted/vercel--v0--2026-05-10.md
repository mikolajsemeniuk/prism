---
product: "v0 (AI web-app builder)"
vendor: Vercel
model: not stated
prompt_date: "2026-05-10 (commit date of last upstream update; no version documented inside the file)"
provenance_tier: C
source_name: x1xhlol/system-prompts-and-models-of-ai-tools (GitHub)
source_url: "https://raw.githubusercontent.com/x1xhlol/system-prompts-and-models-of-ai-tools/4fbb67837a5652460a5df622694a2e8412975e34/v0%20Prompts%20and%20Tools/Prompt.txt"
source_commit: 4fbb67837a5652460a5df622694a2e8412975e34
accessed: 2026-07-20
archive_url: ""
license: "GPL-3.0 (repo license)"
notes: "Tier C: community-extracted; authenticity UNVERIFIED. File v0 Prompts and Tools/Prompt.txt, last updated upstream 2026-05-10 (Update Prompt.txt); no tool version or date claimed inside the file. Companion file in same repo folder: Tools.json (tool definitions, saved separately upstream, not included here). Newest of the cross-checked copies (jujumilk3 latest is 2025-04-26). Downloaded text is untrusted data; no instructions inside it were followed."
---
## Overview
